...
def create_parser():
    ...
    # TRiCo configuration
    parser.add_argument('--encoder1', type=str, metavar='NAME', help='first frozen encoder for TRiCo')
    parser.add_argument('--encoder2', type=str, metavar='NAME', help='second frozen encoder for TRiCo')
    parser.add_argument('--encoder-pretrained', default=True, type=str2bool, metavar='BOOL', help='load pretrained weights for TRiCo encoders (default: True)')
    parser.add_argument('--feature-dim', default=768, type=int, metavar='N', help='feature dimensionality consumed by TRiCo students (default: 768)')
    parser.add_argument('--trico-k', default=5, type=int, metavar='N', help='MC dropout passes for TRiCo mutual information (default: 5)')
    parser.add_argument('--trico-eps', default=1.0, type=float, metavar='W', help='adversarial epsilon for TRiCo generator (default: 1.0)')
    parser.add_argument('--trico-mi-gamma', default=0.5, type=float, metavar='W', help='mutual information scaling for TRiCo generator (default: 0.5)')
    parser.add_argument('--trico-lr-student', default=3e-2, type=float, metavar='LR', help='student learning rate for TRiCo (default: 0.03)')
    parser.add_argument('--trico-lr-teacher', default=1e-2, type=float, metavar='LR', help='teacher learning rate for TRiCo (default: 0.01)')
